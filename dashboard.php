                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="progress-container progress-sm">
                                                        <div class="progress">
                                                            ...
                                                            <p> <span class="progress-value" id="Tania Mike"></span></p>
                                                ...
                                                <td class="text-right">
                                                    <button type="button" rel="tooltip" class="btn btn-success btn-link btn-icon btn-sm btn-simple" data-original-title="Tooltip on top" title="Start">
                                        <i class="fa fa-play"></i>
                                      </button>
                                                    <button type="button" rel="tooltip" class="btn btn-danger btn-link btn-icon btn-sm btn-simple" data-original-title="Tooltip on top" title="Stop">
                                        <i class="fa fa-stop"></i>
                                      </button>
                                                    <button type="button" rel="tooltip" class="btn btn-danger btn-link btn-icon btn-sm btn-simple" data-original-title="Tooltip on top" title="Refresh">
                                        <i class="fa fa-refresh"></i>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="progress-container progress-sm">
                                                        <div class="progress">
                                                            <p> <span class="progress-value" id="John Doe"></span></p>
                                                            <div class="slidecontainer">
                                                ...
                                                <td class="text-right">
                                                    <button type="button" rel="tooltip" class="btn btn-success btn-link btn-sm btn-icon btn-simple" data-original-title="Tooltip on top" title="Start">
                                        <i class="fa fa-play"></i>
                                      </button>
                                                    <button type="button" rel="tooltip" class="btn btn-danger btn-link btn-sm btn-icon btn-simple" data-original-title="Tooltip on top" title="Stop">
                                        <i class="fa fa-stop"></i>
                                      </button>
                                                    <button type="button" rel="tooltip" class="btn btn-danger btn-link btn-sm btn-icon btn-simple" data-original-title="Tooltip on top" title="Refresh">
                                        <i class="fa fa-refresh"></i>
                                      </button>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="progress-container progress-sm">
                                                        <div class="progress">
                                                            <p> <span class="progress-value" id="Alexa Mike"></span></p>
                                                            <div class="slidecontainer">
                                        ...
                                        <i class="fa fa-refresh"></i>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="progress-container progress-sm">
                                                        <div class="progress">
                                                            <p> <span class="progress-value" id="Jana Monday"></span></p>
                                                            <div class="slidecontainer">
                                        ...
                                        <i class="fa fa-refresh"></i>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="progress-container progress-sm">
                                                        <div class="progress">
                                                            <p> <span class="progress-value" id="Paul Dickens"></span></p>
                                                            <div class="slidecontainer">
                                        ...
                                        <i class="fa fa-refresh"></i>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <div class="progress-container progress-sm">
                                                        <div class="progress">
                                                            <p> <span class="progress-value" id="Manuela Rico"></span></p>
                                                            <div class="slidecontainer">
                                                                <input type="range" min="1" max="100" value="1" class="slider" id="myRange5">
                                                            </div>
                                                        </div>
                                                </td>
                                                <td class="text-right">
